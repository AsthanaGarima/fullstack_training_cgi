			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form:form action="saveStudent" cssClass="form-horizontal"
						...
						<div class="form-group">
							<label for="nationality" class="col-md-3 control-label">
								Nationality</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<label for="entering_date" class="col-md-3 control-label">Date</label>
							<div class="col-md-9">
								<form:input path="entering_date" cssClass="form-control" />
							</div>
						</div>
