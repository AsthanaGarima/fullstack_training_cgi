...
<body>
	<div class="container">
		<div class="col-md-offset-1 col-md-10">
			<h2><font color='red'>CRM - Student Relationship Manager</font></h2>
			<hr />
			...
			<br/>
			<input type="button" value="Find Student By Id"
				onclick="window.location.href='showFormFindId'; return false;"
				class="btn btn-primary" />
					...
					<table class="table table-striped table-bordered">
						...
						<!-- construct an "update" link with customer id -->
							...
							<tr>
								...
								<td>${tempCustomer.entering_date}</td>
